...
_D4C_ROOT = os.path.abspath(os.path.join(_LEGACY_DIR, "..", ".."))
...
if __name__ == "__main__":
    ...
    out_path = os.path.join(_D4C_ROOT, "stats.out")
    for i, dataset in enumerate(datasets):
        df = pd.read_csv(os.path.join(_D4C_ROOT, "data", dataset, "processed.csv"))
        compute(df, out_path, dataset)
