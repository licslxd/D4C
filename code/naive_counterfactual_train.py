...
if __name__ == "__main__":
    ...
    suser_profiles = torch.tensor(np.load(os.path.join(DATA_DIR, args.auxiliary, "user_profiles.npy")), dtype=torch.float, device=config.get("device"))
    sitem_profiles = torch.tensor(np.load(os.path.join(DATA_DIR, args.auxiliary, "item_profiles.npy")), dtype=torch.float, device=config.get("device"))
    sdomain_profiles = torch.tensor(np.load(os.path.join(DATA_DIR, args.auxiliary, "domain.npy")), dtype=torch.float, device=config.get("device"))
    tuser_profiles = torch.tensor(np.load(os.path.join(DATA_DIR, args.target, "user_profiles.npy")), dtype=torch.float, device=config.get("device"))
    titem_profiles = torch.tensor(np.load(os.path.join(DATA_DIR, args.target, "item_profiles.npy")), dtype=torch.float, device=config.get("device"))
    tdomain_profiles = torch.tensor(np.load(os.path.join(DATA_DIR, args.target, "domain.npy")), dtype=torch.float, device=config.get("device"))
